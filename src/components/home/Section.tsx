    ...
    return (
        <section className={
            ...
            <div className="flex-[4_0_0%] lg:flex lg:flex-col lg:items-center lg:justify-center lg:text-center lg:max-w-[40rem]" data-aos={"fade-" + (props.imagePosition === "right" ? "right" : "left")} data-aos-offset="100">
                ...
                {
                    props.discordButton &&
                    <Button type="link" href="/discord" blank className="bg-blue-500 hover:bg-blue-400 mt-8 flex items-center w-fit px-10 py-3 justify-center">
                        ...
                        <span className="ml-2">Discord'a Katıl</span>
                    </Button>
                }
            </div>
        </section>
